...
## Slide 6: Dataset and Scope

### Slide content
LANL-2015: 58 days, 1.6B+ events, 749 red-team events, 308 unique red-team source-destination pairs.

### Speaker notes
The pipeline uses three LANL files: authentication events, network flows, and red-team ground truth. To avoid loading all 1.6B events, it scopes processing to ±3,600 seconds around red-team events, merges overlaps into 25 intervals, and streams only events inside those windows.
...
## Slide 16: Main Method Comparison
...
## Slide 19: Nelder-Mead vs Logistic Regression
...
## Slide 21: Multi-Hop Feature Sweep
...
## Slide 22: What Actually Drives Detection
...
## Slide 23: Limitations and Deployment Cautions

### Slide content
LANL is one environment; some strongest signals may be dataset-specific.

### Speaker notes
The feature audit depends on LANL red-team labels, so the selected set should be rechecked on held-out windows or another dataset. LANL attacks emphasize SMB, SSH, credential reuse, and reconnaissance. DAPT2020 is simulated. Personalized PageRank should be framed as post-detection scoping, not cold-start detection. Real deployments also face scaling, log cost, SIEM integration, and encrypted traffic issues.
