...
Additional analysis scripts in the \texttt{analysis/} directory perform held-out validation of the weight optimizer, logistic-regression baseline comparison, tabular versus graph feature ablation, and graph feature extension sweeps. These are separate from the main pipeline and operate on cached edge tables.
