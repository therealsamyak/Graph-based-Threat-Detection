...
We extract 23 unique features total, from edges (11), nodes (7), and graph (5).
...
\begin{itemize}
\item Narrow feature set to 3-5 per log type (auth, flow) that are standardized. Likely will just pick based on common sense / what appears interesting.
\end{itemize}
\end{itemize}
