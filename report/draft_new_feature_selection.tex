%% DRAFT — Feature Selection (NEW SECTION)
%% ACTION: Insert as new Section 4.3, after Feature Extraction (current 4.2)
%% This shifts current 4.3 (Edge Scoring) to 4.5, current 4.4 (Path) to 4.6,
%% current 4.5 (Threshold) to 4.7.
%%
