%% NEW — Section 4.4 (Weight Optimization)
...
\caption{Held-out validation of the Nelder-Mead optimizer. Calibration and evaluation AUCs converge over iterations, confirming the learned weights generalize.}
