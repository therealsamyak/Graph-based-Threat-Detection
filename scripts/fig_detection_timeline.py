"""Generate detection timeline figures per variant."""
...
def main() -> None:
    args = parse_args("Generate detection timeline figures")
    apply_paper_style()
    ...
    from src.figures.detection import plot_detection_timeline

    plot_detection_timeline(results_dir, baselines_dir, output_dir)
