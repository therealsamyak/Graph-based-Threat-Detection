"""Generate performance-tradeoff figure."""
...
def main():
    args = parse_args("Generate performance-tradeoff figure")
    apply_paper_style()
    ...
    from src.figures.comparison import plot_performance_tradeoff
    plot_performance_tradeoff(matrix, output_dir)
