"""Generate variant heatmap figure."""
...
def main():
    args = parse_args("Generate variant heatmap figure")
    apply_paper_style()
    ...
    from src.figures.comparison import plot_variant_heatmap
    plot_variant_heatmap(matrix, output_dir)
