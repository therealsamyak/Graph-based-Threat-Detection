...
def main():
    args = parse_args("Generate radar-chart figures")
    apply_paper_style()
    ...
    from src.figures.methods import plot_radar_chart
    plot_radar_chart(matrix, output_dir)
